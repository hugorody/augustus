...
perl getAnnoFasta.pl "$i"

sed -i "s/.t1//g" "$name"3.aa #this number 3 is based on the output name generated by the getAnnoFasta.pl script
sed -i "s/>/>$idge/g" "$name"3.aa
 
done

cat *.aa > augustus.fasta
rm *.aa
